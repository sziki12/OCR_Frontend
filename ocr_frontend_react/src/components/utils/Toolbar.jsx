...
import {faGears, faHouse, faMapLocationDot, faReceipt,faChartPie} from '@fortawesome/free-solid-svg-icons'
        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position={"static"} >
                <Toolbar>
                    ...
                    <IconButton onClick={()=>{(user.isAuthenticated)?navigate("/chart"):navigate("/login")}}>
